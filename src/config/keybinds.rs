...
pub(super) fn default_keys() -> Vec<KeyBind> {
    ...
    let mut v = vec![
        ...
        // Shift + a number key is matched by the *base* digit keysym (see the
        // layout-agnostic fallback in handlers/input.rs), so these bind the plain
        // digit rather than the layout-specific shifted symbol (exclam, etc.).
        k(M,     xkb::KEY_1, Action::View(1 << 0)),
        k(M|C,   xkb::KEY_1, Action::ToggleView(1 << 0)),
        k(M|S,   xkb::KEY_1, Action::Tag(1 << 0)),
        k(M|C|S, xkb::KEY_1, Action::ToggleTag(1 << 0)),
        k(M,     xkb::KEY_2, Action::View(1 << 1)),
        k(M|C,   xkb::KEY_2, Action::ToggleView(1 << 1)),
        k(M|S,   xkb::KEY_2, Action::Tag(1 << 1)),
        k(M|C|S, xkb::KEY_2, Action::ToggleTag(1 << 1)),
        k(M,     xkb::KEY_3, Action::View(1 << 2)),
        k(M|C,   xkb::KEY_3, Action::ToggleView(1 << 2)),
        k(M|S,   xkb::KEY_3, Action::Tag(1 << 2)),
        k(M|C|S, xkb::KEY_3, Action::ToggleTag(1 << 2)),
        k(M,     xkb::KEY_4, Action::View(1 << 3)),
        k(M|C,   xkb::KEY_4, Action::ToggleView(1 << 3)),
        k(M|S,   xkb::KEY_4, Action::Tag(1 << 3)),
        k(M|C|S, xkb::KEY_4, Action::ToggleTag(1 << 3)),
        k(M,     xkb::KEY_5, Action::View(1 << 4)),
        k(M|C,   xkb::KEY_5, Action::ToggleView(1 << 4)),
        k(M|S,   xkb::KEY_5, Action::Tag(1 << 4)),
        k(M|C|S, xkb::KEY_5, Action::ToggleTag(1 << 4)),
        k(M,     xkb::KEY_6, Action::View(1 << 5)),
        k(M|C,   xkb::KEY_6, Action::ToggleView(1 << 5)),
        k(M|S,   xkb::KEY_6, Action::Tag(1 << 5)),
        k(M|C|S, xkb::KEY_6, Action::ToggleTag(1 << 5)),
        k(M,     xkb::KEY_7, Action::View(1 << 6)),
        k(M|C,   xkb::KEY_7, Action::ToggleView(1 << 6)),
        k(M|S,   xkb::KEY_7, Action::Tag(1 << 6)),
        k(M|C|S, xkb::KEY_7, Action::ToggleTag(1 << 6)),
        k(M,     xkb::KEY_8, Action::View(1 << 7)),
        k(M|C,   xkb::KEY_8, Action::ToggleView(1 << 7)),
        k(M|S,   xkb::KEY_8, Action::Tag(1 << 7)),
        k(M|C|S, xkb::KEY_8, Action::ToggleTag(1 << 7)),
        k(M,     xkb::KEY_9, Action::View(1 << 8)),
        k(M|C,   xkb::KEY_9, Action::ToggleView(1 << 8)),
        k(M|S,   xkb::KEY_9, Action::Tag(1 << 8)),
        k(M|C|S, xkb::KEY_9, Action::ToggleTag(1 << 8)),
